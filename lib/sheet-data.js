...
// y añade el enlace aquí abajo, en una línea nueva.
...
export async function getPlayerSeasonAverage(playerName) {
  ...
  // Media "por 90 minutos": (total del stat / minutos totales jugados) x 90.
  // Así un jugador que solo jugó 10 minutos no distorsiona su media como si
  // hubiera jugado el partido completo. Si aún no tiene minutos registrados,
  // devolvemos null (no hay base fiable para calcular la media todavía).
  const per90 = (key) => {
