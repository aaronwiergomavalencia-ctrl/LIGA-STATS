...
// nuevas a la hoja (córners...), añade aquí una línea más con el mismo
// formato y aparecerán solas en las tres comparativas de equipo.
const STAT_KEYS = [
...
// Árbitro asignado a un partido concreto (por su id), con sus amarillas y
// rojas de ESE partido.
...
// Media de amarillas y rojas de un árbitro concreto, en todos los
// partidos que ha pitado esta temporada (según el documento de árbitros).
...
// Media de amarillas y rojas de TODOS los árbitros (para comparar).
