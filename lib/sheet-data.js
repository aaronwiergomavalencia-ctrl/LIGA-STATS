...
// Por debajo de este número de minutos totales, no mostramos una media
// "por 90" — con tan poca muestra el número sería poco realista.
const MINUTOS_MINIMOS_PARA_MEDIA = 90; // ≈ 1 partido completo
...
export async function getPlayerSeasonAverage(playerName) {
  ...
  // Minutos por fila: si la casilla está vacía pero hay estadísticas
  // registradas, asumimos
