...
// Igual que getContextualPrediction, pero para el equipo entero en vez de
// un jugador: parte de la media de equipo por 90' y la ajusta según el
// rival de ese partido concreto.
export async function getTeamContextualPrediction(teamName, rivalTeamName) {
  const base = await getTeamSeasonAverage(teamName);
  return ajustarPorRival(base, rivalTeamName);
}
